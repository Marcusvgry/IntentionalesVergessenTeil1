...
const invalid_examples = {
    ...
    "m": ["Morgen-Morgenstunde-Morgenritual-Morgenstern", "Markus-Maja-Madrid-Marokko"]
}
...
const rwt_instructions_text = (verbal_fluency_cue) => {
    ...
    Die Wörter dürfen aber auch nicht mit dem gleichen Wortstamm beginnen, also <b>${invalid_examples[verbal_fluency_cue][0]}</b> 
    gelten nur als ein Wort.<br>
    Weiterhin darfst du auch keine Eigennamen aufschreiben, also <b>${invalid_examples[verbal_fluency_cue][1]}</b> gelten nicht.<br>
