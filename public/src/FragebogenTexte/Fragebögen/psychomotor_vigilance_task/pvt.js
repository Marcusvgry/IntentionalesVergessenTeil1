...
var evalPvtPractice = {
  ...
  stimulus: function () {
    ...
    var feedback = pvt_feedback_text(n_practice_trials, pvt_lapse_count, pvt_premature_stopwatch_count, pvt_premature_iti_count);
    
    /* Add "well done" when they got at least practice_correct_threshold correct */
    if (n_practice_trials - pvt_lapse_count - pvt_premature_stopwatch_count >= practice_correct_threshold) feedback = feedback + pvt_praise;
  ...
  on_finish: () => {
    ...
    } else if (n_practice_trials - pvt_lapse_count - pvt_premature_stopwatch_count >= practice_correct_threshold) {
      repeat_practice = false;
...
var timeline = [pvt_start_screen, pvt_practice_outer, pvt_main_instructions, pvt_core, pvt_end_screen]
