...
const pvt_start_p2 = 
`<div class="instructions"> 
    <b>Du musst die Uhr innerhalb von ${lapse_time/1000} s stoppen</b>, aber "übermenschliche" 
    Reaktionszeiten unter ${premature_time/1000} s zählen ebenfalls als Fehler.<br>
...
${responses_iti > 0 ? "<br><b>Hinweis:</b> Drücke keine Tasten, solange die Stoppuhr noch nicht hoch zählt!<br>" : ""}
<br><br>`
...
`<div class="instructions">
    ...
    Du musst jede Uhr innerhalb von ${lapse_time/1000} Sekunden stoppen, aber implausible 
