...
const psqi_bed_warning = "Du scheinst morgens/tagsüber ins Bett zu gehen. Stelle sicher, dass es sich dabei nicht um einen Fehler handelt, bevor du deine Antwort abschickst.\n";
const psqi_wake_up_warning = "Du scheinst sehr spät am Tag/in der Nacht aufzuwachen. Stelle sicher, dass es sich dabei nicht um einen Fehler handelt, bevor du deine Antwort abschickst.\n";
const psqi_sleep_warning = "Du scheinst länger zu schlafen, als du Zeit im Bett verbringst. Stelle sicher, dass es sich dabei nicht um einen Fehler handelt, bevor du deine Antwort abschickst.\n";
...
const psqi_table_note = "Wie oft hast du während der letzten vier Wochen schlecht geschlafen, ...";

const psqi_open_answer = "Bitte beschreiben:";

const psqi_table_options = ["Sehr gut", "Ziemlich gut", "Ziemlich schlecht", "Sehr schlecht"]

const psqi_sleep_q_prompt = "Wie würdest du insgesamt die Qualität deines Schlafes während der letzten vier Wochen beurteilen?";
